An android application built in kotlin using ARcore and Sceneform for users to look at glasses in a 3d environment and try them on using immersive technologies.
